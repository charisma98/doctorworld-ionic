...
@Component({
  selector: 'app-doctoworld-book-appointment',
  templateUrl: './doctoworld-book-appointment.page.html',
  styleUrls: ['./doctoworld-book-appointment.page.scss'],
})
export class DoctoworldBookAppointmentPage implements OnInit {
  faqExpand1: boolean;
  faqExpand2: boolean;
  faqExpand3: boolean;
  faqExpand4: boolean;
